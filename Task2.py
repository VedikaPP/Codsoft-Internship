#Task 2 CALCULATER Given by Codsoft
...
def create_button(text, row, col, col_span=1):
    button = tk.Button(root, text=text, font=("Helvetica", 18),bg='azure', bd=5)
...
heading_label = tk.Label(root, text="Calculator", font=("arial", 16, "bold"),bg='pink',highlightcolor=("red"))
heading_label.grid(row=0, column=0, columnspan=4, pady=20)

entry = tk.Entry(root, font=("Helvetica", 24),bg='wheat', bd=5, justify=tk.RIGHT)
